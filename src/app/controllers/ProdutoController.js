...
class ProdutoController {
    ...
    async search(req, res) {
        ...
        COALESCE(p1.preco_promocao, e.preco_venda) AS preco_vigente, e.preco_venda,  e.preco_venda, e.preco_venda as preco_original, p1.preco_promocao, p1.data_inicio, p1.data_fim, f.path AS image, p.principio, 
